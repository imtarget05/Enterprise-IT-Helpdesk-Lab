...
/**
 * Dữ liệu mẫu doanh nghiệp (pre-seeded) — chỉ dùng khi data/db.json chưa tồn tại.
 * Nguồn: kịch bản ITIL thật của phòng lab (tickets/INC-10xx) + kiểm kê tài sản BMC VN.
 */
function seedData() {
  return {
    assets: [
