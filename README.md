...
[![CI](https://github.com/imtarget05/Enterprise-IT-Helpdesk-Lab/actions/workflows/ci.yml/badge.svg)](https://github.com/imtarget05/Enterprise-IT-Helpdesk-Lab/actions/workflows/ci.yml)
...
### 1. Lab Windows Server 2022 (VMware)
...
| 012 | Xóa nhầm file quan trọng | Khôi phục từ Shadow Copy của Windows Server |
| 015 | Nhân viên nghỉ việc | Quy trình offboarding: vô hiệu AD, thu hồi tài sản, thu hồi bản quyền |
...
- Tiếp nhận và xử lý sự cố người dùng (mạng, máy tính, email, tài khoản)
...
├── scripts/              ← PowerShell automation (user, inventory, network)
...
- **Web app:** Node.js / Express + Vanilla JS (không cần build, mở là chạy)
- **Lab server:** Windows Server 2022, VMware Workstation
- **Automation:** PowerShell 7
- **Container:** Docker (cho portal)
- **CI/CD:** GitHub Actions — chạy test tự động trên Node 18/20/22

---

## Tài liệu tham khảo

- [Topology & cấu hình VM](docs/01-lab-topology-vmware.md)
- [Cài đặt AD / DNS / DHCP](docs/02-ad-dns-dhcp-setup.md)
